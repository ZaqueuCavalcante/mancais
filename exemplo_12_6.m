% Exemplo 12-6 - Mancal com lubrificação forçada.

% Dados da questão:

grau_oleo = 20;    % Grau do lubrificante - óleo SAE.
pressao_medidor = 207E6;    % Pressão à qual o lubrificante é fornecido.
N = 3000 / 60;    % Velocidade angular do eixo - [rev/s].

W = 4E3;    % Carga radial permanente - [N].
d_eixo = 44.45E-3;    % Diâmetro do eixo - [m].
r_eixo = d_eixo/2;    % Raio do eixo - [m].
l_linha_mancal = (1/2)*d_eixo;    % Razão l_linha/d = 1/2.
c_radial = 0.040E-3;    % Folga radial - [m].

P = W/(l_linha_mancal*d_eixo);    % Carga radial por unidade de área projetada - [Pa].
